...
public class Globalformfill {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@class = 'email']")).sendKeys("test3@gmail.com");
		...
		driver.findElement(By.xpath("//textarea[@name = 'g2599-comment']")).sendKeys("Assignment completed");
	    Thread.sleep(3000);
